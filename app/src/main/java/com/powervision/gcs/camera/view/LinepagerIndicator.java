...
public class LinepagerIndicator extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFF26292b;
    private int underlineColor = 0xFFFFFFFF;// 0xFF83888f
    private int dividerColor = 0xFFFFFFFF;
    private int textSelectedColor = 0xFF26292b;
    private int textUnselectColor = 0xFF83888f;
